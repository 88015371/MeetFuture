...
import com.zjman.meetfuture.data.net.interceptor.Auth2Interceptor;
    ...
    private static OkHttpClient getOkHttpClient() {
        ...
        clientBuilder
              ...
              //  .addInterceptor(new HeaderInterceptor())
                .addInterceptor(new Auth2Interceptor(AppContext.context(), ServerAPI.BASE_URL));//OAuth认证
        ...
        if (sServerAPI == null) {
            synchronized (RequestClient.class) {
                if (sServerAPI == null) {
                    ...
                    sServerAPI = getRetrofitBuilder(ServerAPI.BASE_URL, getOkHttpClient()).build().create(ServerAPI.class);
                }
            }
        }
        return sServerAPI;
