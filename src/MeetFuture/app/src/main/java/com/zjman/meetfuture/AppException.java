...
public class AppException implements Thread.UncaughtExceptionHandler {
    ...
    public void uncaughtException(Thread thread, Throwable ex) {
        ...
        if (!handleException(ex) && mDefaultHandler != null) {//如果没有处理异常则交给系统处理
            ...
            if (System.currentTimeMillis() - AppContext.sStartTime > 5000) {
                AppNavigator.showCrashActivity(AppContext.context(), ex.getMessage(), getCrashReport(AppContext.context(), ex));
            }
