...
//                requestCode, intent, FLAG);
        ...
        //TODO ----------------缺少封装
      //  Intent dismissIntent = new Intent(IMNotifyReceiver.ACTION_DISMISS, null, AppContext.context(), IMNotifyReceiver.class);
      //  PendingIntent dismissPendingIntent = PendingIntent.getBroadcast(AppContext.context(), 0, dismissIntent,
       //         0);
       // cBuilder.setDeleteIntent(dismissPendingIntent);
        //TODO ----------------缺少封装
...
//                requestCode, intent, FLAG);
    ...
    public void notify_mailbox(PendingIntent pendingIntent, int smallIcon, int largeIcon, ArrayList<String> messageList,
        ...
        notify_mailbox(pendingIntent, smallIcon, bitmap, messageList, ticker,
     ...
     * 进行多项设置的通知(在小米上似乎不能设置大图标，系统默认大图标为应用图标)
     */
    public void notify_mailbox(PendingIntent pendingIntent, int smallIcon, Bitmap largeIcon, ArrayList<String> messageList,
                               String ticker, String title, String content, boolean sound, boolean vibrate, boolean lights) {
